...
set "SCHOOL_DATA=inputs\forecasting\school_old_training_data_exclusion_informed_finetuned.csv"
set "SCHOOL_CYCLICAL_DATA=inputs\forecasting\k12_exclusion_informed_finetuned_tempo_naqfc_forecast_training_cyclical.csv"
set "ALL_DATA=inputs\forecasting\all_old_training_data_exclusion_informed_finetuned.csv"
set "ALL_CYCLICAL_DATA=inputs\forecasting\all_old_training_data_exclusion_informed_finetuned_cyclical.csv"
